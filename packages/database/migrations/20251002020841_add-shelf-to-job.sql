ALTER TABLE "job" ADD COLUMN "shelfId" TEXT;

ALTER TABLE "job" ADD CONSTRAINT "job_shelfId_fkey" FOREIGN KEY ("shelfId") REFERENCES "shelf" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
