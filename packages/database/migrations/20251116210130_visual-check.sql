ALTER TYPE "procedureStepType" ADD VALUE 'Inspection';

ALTER TABLE "jobOperationStep" ADD COLUMN "nonConformanceActionId" TEXT;
ALTER TABLE "jobOperationStep" ADD COLUMN "nonConformanceInvestigationId" TEXT;

ALTER TABLE "jobOperationStep" ADD CONSTRAINT "jobOperationStep_nonConformanceActionId_fkey" FOREIGN KEY ("nonConformanceActionId") REFERENCES "nonConformanceActionTask"("id") ON DELETE CASCADE;
