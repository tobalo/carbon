-- Redefine functions to use readableId column instead of attributes for batch/serial numbers
...
BEGIN
  ...
  -- Build attributes JSONB (without Batch Number, as it now goes in readableId)
  ...
  -- Upsert the tracked entity with readableId
...
BEGIN
  ...
  -- Build attributes JSONB (without Serial Number, as it now goes in readableId)
  v_attributes := jsonb_build_object(
    'Receipt Line', p_receipt_line_id,
    'Receipt', p_receipt_id,
