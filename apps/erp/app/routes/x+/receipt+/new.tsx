...
export async function action({ request }: ActionFunctionArgs) {
  ...
  switch (sourceDocument) {
    case "Purchase Order":
      const purchaseOrderReceipt = await invokeCarbonServiceFunction<{
        id: string;
      }>("create", {
        body: {
    ...
    case "Inbound Transfer":
      const warehouseTransferReceipt = await invokeCarbonServiceFunction<{
        id: string;
      }>("create", {
        body: {
    ...
    default:
      const defaultReceipt = await invokeCarbonServiceFunction<{
        id: string;
      }>("create", {
        body: {
          type: "receiptDefault",
